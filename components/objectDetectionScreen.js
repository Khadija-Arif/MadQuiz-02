...
const ImageClassifier = () => {
  ...
  return (
    <View style={classifyStyle.container}>
      {selectedImage && (
        <Image
      ...
      <View style={classifyStyle.buttonContainer}>
        <Pressable
          style={({ pressed }) => [
            {
              backgroundColor: pressed ? '#586F7C' : '#007AFF',
            },
            classifyStyle.button,
          ]}
          onPress={selectImage}
        >
          <Text style={classifyStyle.buttonText}>Select Image</Text>
        </Pressable>
        <Pressable
          style={({ pressed }) => [
            {
        ...
        >
          <Text style={classifyStyle.buttonText}>Classify Image</Text>
        </Pressable>
      </View>
